...
instance : Buffer ByteArray UInt8 where
  size := ByteArray.size
  width _ := 1
  width_pos _ := by simp
...
instance : LawfulBuffer ByteArray UInt8 where
  nextTok_saturate _ _ := by simp; congr 1; omega
